...
var _wrs_conf_editorPath = '/proxy/wiris/integration/editor.php';        // _wrs_conf_editorPath = CKEDITOR.basePath + '/plugins/ckeditor_wiris/integration/editor.php';			// Specifies where is the editor HTML code (for popup window).
...
var _wrs_conf_createimagePath = '/proxy/wiris/integration/createimage.php';        // _wrs_conf_createimagePath = CKEDITOR.basePath + '/plugins/ckeditor_wiris/integration/createimage.php';			// Specifies where is createimage script.
...
var _wrs_conf_getmathmlPath = '/proxy/wiris/integration/getmathml.php';        // _wrs_conf_getmathmlPath = CKEDITOR.basePath + '/plugins/ckeditor_wiris/integration/getmathml.php';			// Specifies where is the getmathml script.
var _wrs_conf_servicePath = '/proxy/wiris/integration/service.php';        // _wrs_conf_servicePath = CKEDITOR.basePath + '/plugins/ckeditor_wiris/integration/service.php';			// Specifies where is the service script.
